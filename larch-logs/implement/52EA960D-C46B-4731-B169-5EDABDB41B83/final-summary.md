...
Exec Issues (1):
  1. ship route: merge and CI watch skipped — needs user (reason: first-fixer-non-health; pending NEXT_ACTION=ci-fix)
    Medium materiality: deployment blocked pending CI fix; requires manual intervention to unblock shipping pipeline.
Warnings (0):
...
- Force: true
- **Duration**: 00:31:50
- **Cost**: 💰 TOTAL ~$3.66: Claude/GLM-5.2 token $6.31 (estimated $0.42), Codex-5.6 $0.00, Codex-mini $0.00, Cursor $0.00, Claude (subprocess) $3.24  |  Tokens: 22974k
...
- **Lines (PR diff)**: code +1286/-98, larch-logs +202/-0
- **OOS filed**: 0
- **Exec issues**: 1
- **Warnings**: 0
