...
> Codebase context: `zhupanov/agent-lint` — 225 rules, Rust, Claude Code-focused.
...
Mitigating factors: no dominant player has emerged, agent-lint's 225 rules + GitHub Actions + Rust performance provide a solid foundation.

## Open Questions

1. **What specific rules do competitors implement that agent-lint doesn't?** Agnix claims 399 rules vs agent-lint's 225 — a deep rule comparison would identify borrowable ideas.
