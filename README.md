...
Claude Lint ships **99 rules** organized into 9 categories:
...
| Skills | S | 52 | Skill frontmatter, naming, descriptions, body content, security |
...
| **Plugin** | `.claude-plugin/` directory exists | All 99 rules including manifest, agents, hygiene, and plugin-only S-rules |
...
+-- rules.rs             # Central LintRule enum (99 rules, codes, names)
...
+-- validators/
    ...
    +-- skill_content/   # S009-S052: name, description, body, MCP, security checks
